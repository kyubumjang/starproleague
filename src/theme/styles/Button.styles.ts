...
const button_base = cva(
  [
    ...
    "data-[has-suffix-element=true]:rounded-r-none",
    "data-[has-prefix-element=true]:h-auto",
    "data-[has-suffix-element=true]:h-auto",
  ],
  {
    variants: {
      tone: {
        fill: ["border", "antialiased"],
        light: ["border", "border-transparent", "bg-transparent"],
        line: ["border", "border-transparent", "bg-transparent"],
